...
<html lang="en">
    ...
    body>
        ...
        <header class="header">
            <a href="#" class="logo">
                <img src="https://th.bing.com/th/id/OIP.tZeEXJN-9n027IiKKia2bAHaHa?rs=1&pid=ImgDetMain" class="img-logo" alt=" Logo">
            </a>
        ...
        <section class="home" id="home">
            <div class="content">
                ...
                <p>
                    <strong>We are open 9:00 PM to 9:00 PM.</strong>
                </p>
        ...
        <section class="about" id="about">
            ...
            <div class="row g-0">
                <div class="image">
                    <img src="https://th.bing.com/th/id/R.2053e0d910bb9f2594ce2482e96070ec?rik=KT%2bdRhsR1vzURQ&riu=http%3a%2f%2fwww.pixelstalk.net%2fwp-content%2fuploads%2f2016%2f05%2fCoffee-wallpaper-backgrounds-hd.jpg&ehk=nM5ykWo1rrz6W9YG9Dj%2f7VQXAbfXTMVlYb9buln7zUs%3d&risl=&pid=ImgRaw&r=0" alt="" class="img-fluid">
                </div>
                <div class="content">
                    <h3>Welcome to Coffee Shop!</h3>
                    <p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                <div class="image">
                                    <img src="https://th.bing.com/th/id/OIP.o5lb4VGROjtbTEdEU939GgHaEK?rs=1&pid=ImgDetMain" alt="">
                                </div>
                                <div class="content">
                                    <div class="stars">
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <div class="image">
                                    <img src="https://wallpaperaccess.com/full/1889540.jpg" alt="">
                                </div>
                                <div class="content">
                                    <div class="stars">
                                        <i class="fas fa-star"></i>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <div class="image">
                                    <img src="https://www.wallpapertip.com/wmimgs/50-504684_coffee-shop-background-cafe.jpg" alt="">
                                </div>
                                <div class="content">
                                    <div class="stars">
                                        <i class="fas fa-star"></i>
                    ...
                    <div class="row pic-to-hide">
                        <div class="col-md-4">
                            <div class="box">
                                <div class="image">
                                    <img src="https://wallpaperaccess.com/full/1889619.jpg" alt="">
                                </div>
                                <div class="content">
                                    <div class="stars">
                                        <i class="fas fa-star"></i>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <div class="image">
                                    <img src="https://s.tmimgcdn.com/scr/37800/coffee-shop-website-template_37865-original.jpg" alt="">
                                </div>
                                <div class="content">
                                    <div class="stars">
                                        <i class="fas fa-star"></i>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <div class="image">
                                    <img src="https://th.bing.com/th/id/OIP.piaeFt2LZdWsRSwsW3OFpQHaEK?rs=1&pid=ImgDetMain" alt="">
                                </div>
                                <div class="content">
                                    <div class="stars">
                                        <i class="fas fa-star"></i>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                <div class="image">
                                    <img src="https://th.bing.com/th/id/OIP.GtVNwmTfaLmmnQEWwYcq8AHaEZ?rs=1&pid=ImgDetMain" alt="">
                                </div>
                                <div class="content">
        ...
        <section class="footer">
            <div class="footer-container">
                <div class="logo">
                    <img src="https://th.bing.com/th/id/OIP.tZeEXJN-9n027IiKKia2bAHaHa?rs=1&pid=ImgDetMain" class="img"><br />
                    <i class="fas fa-envelope"></i>
                    <p>coffeehouse@gmail.com</p><br />
                    <i class="fas fa-phone"></i>
                    <p>+91 3469876543</p><br />
                ...
                <div class="credit">
                    <hr /><br/>
                    <h2>Coffee House © 2024 | All Rights Reserved.</h2>
                    <h2>Designed by <span>Swati</span></h2>
                </div>
            </div>
        </section>
        <!-- CHAT BAR BLOCK -->
